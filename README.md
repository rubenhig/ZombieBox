...
- **[docs/](./docs):** Contains detailed documentation on different aspects of the project.
  - **[zombieBox.md](./docs/zombieBox.md):** The original, complete project plan.
  - **[ARCHITECTURE.md](./docs/ARCHITECTURE.md):** Details on the project's structure, scenes, and node organization.
  - **[MULTIPLAYER_NETWORKING.md](./docs/MULTIPLAYER_NETWORKING.md):** In-depth explanation of the client-server model and network synchronization.
  - **[GAMEPLAY_FEATURES.md](./docs/GAMEPLAY_FEATURES.md):** Description of the core game mechanics.
